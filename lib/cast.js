...
async function castToDevice(ip, url, proxy, referer, quality, res, type) {
    console.log(`[Cast] Request received for IP: ${ip}, URL: ${url}, Proxy: ${proxy}, Referer: ${referer}, Quality: ${quality}, Type: ${type || 'auto'}`);
