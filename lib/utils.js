...
const STALL_TIMEOUT = parseInt(process.env.STALL_TIMEOUT_SECONDS || '15') * 1000;

// Constants for connection health
const HEARTBEAT_INTERVAL = parseInt(process.env.HEARTBEAT_INTERVAL_SECONDS || '5') * 1000;
const MAX_MISSED_HEARTBEATS = parseInt(process.env.MAX_MISSED_HEARTBEATS || '3');
const RECONNECT_DELAY = parseInt(process.env.RECONNECT_DELAY_SECONDS || '10') * 1000;
const MAX_RECONNECT_ATTEMPTS = parseInt(process.env.MAX_RECONNECT_ATTEMPTS || '3');

// Cache TTLs (milliseconds)
const CACHE_TTL_VOD = parseInt(process.env.CACHE_TTL_VOD_SECONDS || '60') * 1000;
const CACHE_TTL_LIVE = parseInt(process.env.CACHE_TTL_LIVE_SECONDS || '4') * 1000;
