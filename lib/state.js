...
// Discovered Chromecast and AirPlay devices (IP -> device info)
const devices = {};

// Track when devices were last seen for staleness detection
const deviceLastSeen = new Map();

// Active cast sessions (IP -> { client, player }) for Chromecast
const activeSessions = new Map();

// Active AirPlay sessions (IP -> { url, proxy, referer, startTime })
const activeAirPlaySessions = new Map();
